...
public class ActivateCreditCardCommandHandler(ICreditCardRepository repository) : ICommandHandler<ActivateCreditCardCommand, ErrorOr<ActivateCreditCardResult>>
{
    public async Task<ErrorOr<ActivateCreditCardResult>> Handle(ActivateCreditCardCommand command, CancellationToken cancellationToken)
    {
