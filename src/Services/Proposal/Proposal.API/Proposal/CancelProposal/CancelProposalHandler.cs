...
public class CancelProposalCommandHandler(IProposalRepository repository)
    : ICommandHandler<CancelProposalCommand, ErrorOr<CancelProposalResult>>
{
    public async Task<ErrorOr<CancelProposalResult>> Handle(CancelProposalCommand command,
