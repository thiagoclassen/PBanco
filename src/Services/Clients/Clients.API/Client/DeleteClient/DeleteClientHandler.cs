...
public class DeleteClientCommandHandler(IClientRepository repository) : ICommandHandler<DeleteClientCommand, ErrorOr<DeleteClientResult>>
{
    public async Task<ErrorOr<DeleteClientResult>> Handle(DeleteClientCommand command, CancellationToken cancellationToken)
    {
